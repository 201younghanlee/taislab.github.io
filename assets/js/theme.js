...
// Toggle between dark and light theme settings.
...
// Determine the expected state of the theme toggle. Default is "dark".
...
let initTheme = () => {
  ...
  // Keep the selected site theme independent from system color-scheme changes.
};
